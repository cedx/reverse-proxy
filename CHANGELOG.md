...
- Added the `Application.instance` property.
- Added a user guide based on [MkDocs](http://www.mkdocs.org).
- Added support for multithreading: implements the [GitHub feature request #7](https://github.com/cedx/reverse-proxy/issues/7).
- Fixed the [GitHub issue #6](https://github.com/cedx/reverse-proxy/issues/6): wrong executable name in the documentation.
- Ported the unit tests to classes with experimental decorators.
- Updated the build system to [Gulp](https://gulpjs.com) version 4.
- Updated the package dependencies.
- Using the `fs` promises API.

## Version [9.0.0](https://github.com/cedx/reverse-proxy/compare/v8.0.0...v9.0.0)
- Breaking change: raised the required [Node.js](https://nodejs.org) version.
- Breaking change: renamed the `Application#env` property to `environment`.
- Updated the package dependencies.

## Version [8.0.0](https://github.com/cedx/reverse-proxy/compare/v7.0.0...v8.0.0)
- Breaking change: using camel case instead of studly caps for static properties.
- Updated the package dependencies.

## Version [7.1.0](https://github.com/cedx/reverse-proxy/compare/v7.0.0...v7.1.0)
- Improved the error handling in `Server#listen()` method.
- Updated the package dependencies.

## Version [7.0.0](https://github.com/cedx/reverse-proxy/compare/v6.1.0...v7.0.0)
...
## Version [6.1.0](https://github.com/cedx/reverse-proxy/compare/v6.0.1...v6.1.0)
- Removed the dependency on [Babel](https://babeljs.io) compiler.
- Updated the package dependencies.

## Version [6.0.1](https://github.com/cedx/reverse-proxy/compare/v6.0.0...v6.0.1)
- Fixed a packaging issue.

## Version [6.0.0](https://github.com/cedx/reverse-proxy/compare/v5.0.1...v6.0.0)
- Breaking change: raised the required [Node.js](https://nodejs.org) version.
- Breaking change: restored the [Observable](http://reactivex.io/intro.html) APIs.
- Added new unit tests.
- Updated the package dependencies.

## Version [5.0.1](https://github.com/cedx/reverse-proxy/compare/v5.0.0...v5.0.1)
- Fixed a code generation bug.
- Updated the package dependencies.

## Version [5.0.0](https://github.com/cedx/reverse-proxy/compare/v4.0.1...v5.0.0)
...
## Version [4.0.1](https://github.com/cedx/reverse-proxy/compare/v4.0.0...v4.0.1)
- Fixed the [GitHub issue #5](https://github.com/cedx/reverse-proxy/issues/5): regression in the `Application#setUser` method.

## Version [4.0.0](https://github.com/cedx/reverse-proxy/compare/v3.1.0...v4.0.0)
...
## Version [3.1.0](https://github.com/cedx/reverse-proxy/compare/v3.0.0...v3.1.0)
- Added support for the [Node Security Platform](https://nodesecurity.io) reports.
- Updated the package dependencies.

## Version [3.0.0](https://github.com/cedx/reverse-proxy/compare/v2.2.0...v3.0.0)
...
## Version [2.2.0](https://github.com/cedx/reverse-proxy/compare/v2.1.0...v2.2.0)
- Added support of HTTP headers: feature request from [GitHub issue #4](https://github.com/cedx/reverse-proxy/issues/4).
- Fixed a bug in the reading of the SSL certificates.

## Version [2.1.0](https://github.com/cedx/reverse-proxy/compare/v2.0.0...v2.1.0)
- Using asynchronous file access in `Application#_parseConfig` method.
- Updated the package dependencies.

## Version [2.0.0](https://github.com/cedx/reverse-proxy/compare/v1.2.0...v2.0.0)
- Breaking change: raised the required [Node.js](https://nodejs.org) version.
...
## Version [1.2.0](https://github.com/cedx/reverse-proxy/compare/v1.1.0...v1.2.0)
- Replaced the [Codacy](https://www.codacy.com) code coverage service by the [Coveralls](https://coveralls.io) one.
- Updated the package dependencies.

## Version [1.1.0](https://github.com/cedx/reverse-proxy/compare/v1.0.0...v1.1.0)
- Added the `Server#listening` property.

## Version [1.0.0](https://github.com/cedx/reverse-proxy/compare/v0.7.0...v1.0.0)
...
## Version [0.7.0](https://github.com/cedx/reverse-proxy/compare/v0.6.0...v0.7.0)
...
## Version [0.6.0](https://github.com/cedx/reverse-proxy/compare/v0.5.4...v0.6.0)
...
## Version [0.5.4](https://github.com/cedx/reverse-proxy/compare/v0.5.3...v0.5.4)
- Fixed some bugs.
- Upgraded the package dependencies.

## Version [0.5.3](https://github.com/cedx/reverse-proxy/compare/v0.5.2...v0.5.3)
- Improved the way the server address is reported.
- The application instance is now exposed as `global.app` property.

## Version [0.5.2](https://github.com/cedx/reverse-proxy/compare/v0.5.1...v0.5.2)
- Restored support for configuration files in [JSON](https://json.org) format.
- Upgraded the package dependencies.

## Version [0.5.1](https://github.com/cedx/reverse-proxy/compare/v0.5.0...v0.5.1)
...
## Version [0.5.0](https://github.com/cedx/reverse-proxy/compare/v0.4.1...v0.5.0)
...
## Version [0.4.1](https://github.com/cedx/reverse-proxy/compare/v0.4.0...v0.4.1)
- Upgraded the package dependencies.

## Version [0.4.0](https://github.com/cedx/reverse-proxy/compare/v0.3.0...v0.4.0)
- Breaking change: raised the required [Node.js](https://nodejs.org) version.
- Removed the dependency on [`promise`](https://www.npmjs.com/package/promise) module.
- Upgraded the package dependencies.

## Version [0.3.0](https://github.com/cedx/reverse-proxy/compare/v0.2.0...v0.3.0)
...
- Fixed the [GitHub issue #1](https://github.com/cedx/reverse-proxy/issues/1): using a Unix system for publishing the package on [npm](https://www.npmjs.com).
- Upgraded the package dependencies.

## Version [0.2.1](https://github.com/cedx/reverse-proxy/compare/v0.2.0...v0.2.1)
- Added `Application` class, used in CLI script.
- Added sample configuration files.
- Updated the documentation.

## Version [0.2.0](https://github.com/cedx/reverse-proxy/compare/v0.1.0...v0.2.0)
